...
import { RequestQueryBuilder } from '@meiblorn/crud-request';
import { isString, objKeys } from '@meiblorn/util';
...
export class Swagger {
  ...
  static createQueryParamsMeta(name: BaseRouteName, options: MergedCrudOptions) {
    ...
    const docsLink = (a: string) =>
      `<a href="https://github.com/meiblorn/crud/wiki/Requests#${a}" target="_blank">Docs</a>`;
