...
- :dart: [General Information](https://github.com/meiblorn/crud/wiki#why)
- :video_game: [CRUD Controllers](https://github.com/meiblorn/crud/wiki/Controllers#description)
- :horse_racing: [CRUD ORM Services](https://github.com/meiblorn/crud/wiki/Services#description)
- :trumpet: [Handling Requests](https://github.com/meiblorn/crud/wiki/Requests#description)
...
- Run `yarn pub` - this will publish on the npm repo (need to be logged under meiblorn `yarn login`)
